...
const useWindowResize: () => number[] = () => {
	// console.clear()
	console.group("ΩΩΩ useWindowResize ΩΩΩ")

	// The stateful data (state): innerWidthHeight: number[] = [ window.innerWidth, window.innerHeight ]
	...
	// useEventListener(
	// 	  target: EventTarget | null, type: string,
