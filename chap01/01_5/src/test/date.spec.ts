...
it("7. testMakeDateWithFormat", () => {
    const makeDateWithFormat: string = U.makeDateWithFormat(new Date())                 // OK, Default Format: 2023/11/22 09:39:07
    // const makeDateWithFormat: string = U.makeDateWithFormat(new Date(), "yyyy/MM/dd")   // OK, Format: 2023/11/22
