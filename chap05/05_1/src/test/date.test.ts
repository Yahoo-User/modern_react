...
it("2. testMakeRelativeDate", () => {
    const relativeDate: string | null = 
        U.makeRelativeDate(new Date())
...
it("3. testRandomRelativeDate", () => {
    const randomRelativeDate: string | null = 
        U.randomRelativeDate()
...
it("4. testMakeDayMonthYear", () => {
    const makeDayMonthYear: string = 
        U.makeDayMonthYear(U.makeRandomPastDate())
...
it("5. testMakeDateWithTime", () => {
    const makeDateWithTime: string = 
        U.makeDateWithTime(U.makeRandomPastDate())
